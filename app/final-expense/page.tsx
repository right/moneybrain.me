...
export default function FinalExpensePage() {
  return (
    <main className="fe-page">
      ...
      </div><div className="fe-hero-image" aria-label="Older family planning ahead for final expenses" /></div></section>
      ...
      <a className="fe-sticky-call" href={site.finalExpensePhoneHref}>Call now: {site.finalExpensePhone}</a>
    </main>
  );
}
