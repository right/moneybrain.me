  ...
  return (
    <main className="fe-page">
      <section className="fe-hero"><div className="fe-wrap fe-hero-grid"><div>
        ...
        <div className="fe-call-card"><p>Prefer to talk? Call now for free help.</p><FinalExpensePhone className="fe-call-btn" /><span>No pressure. No obligation.</span></div>
      </div><FinalExpensePhone className="fe-sticky-call" label="callNow" /><div className="fe-hero-image" aria-label="Older family planning ahead for final expenses" /></div></section>
      ...
      <section className="fe-section fe-wrap fe-form-block"><div><h2>Not ready to call?</h2><p>Send your information and someone can follow up. Calling is still the fastest way to get help.</p><FinalExpensePhone className="fe-secondary-call" label="orCall" /></div><LeadForm compact /></section>
