  ...
  return (
    <main className="fe-page">
      <section className="fe-hero"><div className="fe-wrap fe-hero-grid"><div>
        ...
        <div className="fe-call-card"><p>Get free help from a licensed agent today.</p><FinalExpensePhone className="fe-call-btn" label="callNow" showNumber /><span>No pressure. No obligation.</span></div>
      </div><FinalExpensePhone className="fe-sticky-call" label="freeConsultation" showNumber /><div className="fe-hero-image" aria-label="Older family planning ahead for final expenses" /></div></section>
      ...
      <section className="fe-section fe-wrap fe-form-block"><div><h2>Not ready to call?</h2><p>Send your information and someone can follow up. Calling is still the fastest way to get help.</p><FinalExpensePhone className="fe-secondary-call" label="orCall" showNumber /></div><LeadForm compact finalExpense /></section>
